...
@injectable()
class IndexTreinoUsuarioProfessorService {
  constructor(
  ...
  public async execute(user_id: number): Promise<TreinoUsuario[]> {
    ...
    const treinoUsuario = await this.treinoRepository.indexTreinoUsuarioProfessor(user_id);
    
    return treinoUsuario;
  }
}

export default IndexTreinoUsuarioProfessorService;